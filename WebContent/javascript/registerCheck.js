	...
	function isEmail(fData)
	{
		...
		if(thisform.title.selectedIndex == 0)
			{
				alert("Please select a title");
				return false;
			}
		
		if(thisform.empfirstName.value == null || thisform.empfirstName.value == "")
			{
				alert("Please enter first name");
				return false;
			}
		
		if(thisform.emplastName.value == null || thisform.emplastName.value == "")
		{
		...
		if(thisform.businessPhone.value.length > 0 && !isInteger(thisform.businessPhone.value))
		{
				alert("Business number must be numeric");
				return false;
		}
		...
		if(!document.getElementbyId("CAS"))
		{
			...
			if(thisform.stateResidential.selectedIndex == 0)
			{
			...
			if (document.getElementById('postalCheckID').checked)
			{
				...
				if(thisform.statePostal.selectedIndex == 0)
				{
					alert("Please select state");
					return false;
				}
		...
		//qualifications and reason
		
		//if(thisform.qualification.value == "" || thisform.qualification.value == null)
		//{
		//	alert("Please enter some qualifications");
		//	return false;
		//}
		
		
			
			if(!document.getElementById("income").checked && !document.getElementById("personal").checked && !document.getElementById("experience").checked && !document.getElementById("other").checked)
			{
				alert("Please select a reason for employement");
				return false;
			}
			...
			if(!document.getElementById("citizen").checked && !document.getElementById("perm").checked && !document.getElementById("temp").checked)
			{
			...
			if(document.getElementById("temp").checked)
			{
				...
				if(thisform.passportcountry.value == "" || thisform.passportcountry.value == null)
				{
